...
local text3 = 'Nows you gotz a new number mon, you almost found the Sum,mon!'
local text4 = 'Divide dat by a two, and you got de number be looking for!'
local text5 = 'Sum,mon!  Sum dem!'
local scale = 0.5
...
text_text5 = am.translate(0, -100) ^ am.scale(scale, scale) ^ am.text(mysprites.ReggaeOne32, text5)
